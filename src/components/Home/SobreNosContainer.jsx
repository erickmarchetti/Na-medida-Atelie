    ...
    return (
        <>
            <Stack marginTop="auto" maxW="90vw">
                ...
                >
                    <Text textAlign="justify" fontSize="lg" fontWeight="bold">
                        Lacus interdum lacus at mattis vestibulum cursus platea
                        sit. Dui, phasellus id risus maecenas scelerisque
                        tristique lectus massa. Libero, eleifend mauris, eget
                        nunc sed leo in ut faucibus
                    </Text>
                </motion.div>
            </Stack>
